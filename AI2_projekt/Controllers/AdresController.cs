...
namespace AI2_project.Controllers
{
    public class AdresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Miejscowość,Kod_pocztowy,Ulica,Nr_domu,Nr_lokalu")] Adres adres)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Miejscowość,Kod_pocztowy,Ulica,Nr_domu,Nr_lokalu")] Adres adres)
        {
            if (ModelState.IsValid)
            {
